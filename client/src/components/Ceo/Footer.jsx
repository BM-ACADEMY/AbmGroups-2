      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        ...
        <div className="flex-1 min-w-[200px] md:min-w-[250px]">
          ...
          <p className="max-w-sm mt-6 text-gray-300 text-sm md:text-base">
            We are dedicated to delivering excellence through innovation,
            collaboration, and purposeful growth across all our ventures.
          </p>

          {/* Social Icons */}
          <div className="flex items-center gap-4 mt-6 text-white">
            <a
              href="https://www.facebook.com/bm.kamar4"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/kamarudeen_bm?utm_source=ig_web_button_share_sheet&igsh=MW9lYmc0aTFrNWt2Zg=="
              target="_blank"
              rel="noopener noreferrer"
        ...
        {/* Right Column: Quick Links + Legal + Map */}
        <div className="flex flex-col md:flex-row justify-between w-full md:w-[65%] gap-6 md:gap-10">
          ...
          <div className="flex-1 min-w-[120px] md:min-w-[150px]">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li>
                <a href="#brands" className="hover:text-yellow-400 transition">
                  Brands
                </a>
              </li>
              <li>
          ...
          {/* Legal (links only, modals removed) */}
